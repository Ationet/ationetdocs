...
- [7 Transactions Download Interface](#7-transactions-download-interface)
	...
	- [7.2 <del>Transactions Download (POST) – Body Section Format Request</del> Obsolete](#72-transactions-download-post--body-section-format-request-Obsolete)
	- [7.3 <del>Transactions Download (POST) – Body Section Format Response</del> Obsolete](#73-transactions-download-post--body-section-format-response-Obsolete)
