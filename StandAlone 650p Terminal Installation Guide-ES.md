...
- Cable USB (Hembra) a tipo C (Macho) ([Ejemplo del tipo de cable requerido]([USB hembra a tipo C mach](https://github.com/Ationet/ationetdocs/blob/master/Content/Images/Verifone%20T650p/USB%20hembra%20a%20tipo%20C%20macho.webp))
- USB pendrive
