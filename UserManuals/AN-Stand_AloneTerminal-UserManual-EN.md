...
<!--
## Other Products:
 ATIONET also lets you work with non-fuel products such as additives, lubricants, dry goods and even cash advances. To send to the central server authorization transactions of these products they must be created in the product master of the POS and assign a code of equivalence with the centralized code used for this product at the network level.<br>
 <br>
 To register, modify or delete such products at POS level it will be necessary to enter the option 2 form the configuration menu and maintain from there the master of other products. Importantly, this type of service depends on the network at the central level to be configured to accept these product that are accurately known equivalences between local products in the central station and network-level peers.<br> 
 <br>
 To create, modify or delete any of these products press the button (2) in the configuration menu and follow the instructions below:
...
<table>
	...
	<tr>
		...
		<td> 
			...
			<br>
			A. Keys to Create, Edit or Delete <br>
			B. Details of the active product catalog <br>
			C. Keys to scroll between products <br>
		</td>
	</tr>
</table>

## Create New Products:
 To create a new product in the local catalog press the side button of the corresponding screen and follow the instructions below:
...
## Edit Products:
 To edit a product in the local catalog, please scroll with the bottom keys to change the product to display on the screen and then press the corresponding button on the side screen and follow the instructions below:
...
## Erase Products:
 To delete a product in the local catalog, please scroll with the bottom keys to change the product to display on the screen and then press the side button on the screen. Pressing the side key, the product displayed is deleted permanently. ALWAYS BE SURE ABOUT THE CORRECT PRODUCT BEFORE PRESSING CLEAR:
