...
|2.0|03/Feb/2022|- Se incluyen funcionalidades no contempladas
...
- [Funcionalidades no contempladas](#funcionalidades-no-contempladas) 
...
- **Subsidios**: no soporta subsidios.
- **Mantener bloqueo de pin**: al vencer los intentos de ingreso de pin se bloquea el id, pero al volver nuevamente al modo online no permanece bloqueado.
- **Tipos de combustible**: no comtempla en modo offline los tipos de combustible.
- **Consulta de saldo**: esta funcionalidad esta fuera de alcance.
- **Reversar transacciones**: la reversa de transacciones no se puede realizar, envía mensaje de transaccion no soportada.
- **Mensajes en español**: la mensajería corta que esta configurada originalmente en español, en su versión offline, se genera en ingles. Por ejemplo: PIN Primario Invalido, Transaccion no soportada, etc.
