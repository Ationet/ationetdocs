...
If for some reason it is necessary to recharge a Consumer Card directly from the terminal instead from the portal itself, this option will allow to do so.
